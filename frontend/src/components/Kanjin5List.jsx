...
const Kanjin5List = () => {
  ...
  return (
    <div>
        ...
        <h2 className='subtitle'>Daftar Kanji Dasar</h2>
        <div className="columns">
            <div className="column">
            <Link to="/kanjin5/add" className='button is-primary'>Tambah</Link>
            </div>
        ...
        <table className='table is-striped is-bordered is-hoverable is-fullwidth' style={{backgroundColor: '#FFFFE0'}}>
            ...
            <tbody>
                {kanjin5.map((kanjin5, index)=>(
                <tr key={kanjin5.uuid}>
                    <td>{index + 1}</td>
                    <td>{kanjin5.kanji}</td>
                    <td>{kanjin5.onyomi}</td>
                    <td>{kanjin5.kunyomi}</td>
                    <td>{kanjin5.arti}</td>
