...
const FormAddKataKerja = () => {
  ...
  return (
    <div>
        ...
        <h2 className='subtitle'>Tambahkan Kata Kerja Baru</h2>
        <div className="card is-shadow" style={{backgroundColor: '#FFFFE0'}}>
            <div className="card-content">
                <div className="content">
                <form onSubmit={saveKataKerja}>
...
export default FormAddKataKerja